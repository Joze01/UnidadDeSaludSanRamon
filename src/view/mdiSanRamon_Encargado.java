 ...
 * @author antonio
 */
public class mdiSanRamon_Encargado extends javax.swing.JFrame {
    ...
    private void itemValesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemValesActionPerformed
        if(ValeMantenimiento.bandera==0)
        {
            try {
                ...
                Logger.getLogger(mdiSanRamon_Encargado.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mdiSanRamon_Encargado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mdiSanRamon_Encargado().setVisible(true);
            }
        });
    }
